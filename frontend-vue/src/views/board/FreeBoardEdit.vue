        ...
        <div class="row mt-3">
          ...
          <div class="col-md-2 d-flex align-items-center justify-content-end">
            <div class="form-check">
              ...
              />
              <label v-if="isAdmin" class="form-check-label" for="noticeCheck"
                >공지사항</label
              >
            </div>
          </div>
          ...
          <div class="col-md-3 mb-3 align-items-center d-flex">
            <div align="center">
              <button
                ...
                data-bs-target="#place-modal-free-edit"
                @click="relayout"
              >
...
export default {
  ...
  methods: {
    ...
    async retrieveUpCode() {
      try {
        let response = await BoardEditService.getCmCd("BO03"); // BO03 코드를 가져오도록 수정
